...
?>
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Administrar Estudiantes  
						<?php
						echo (isset($_GET['action']) && @$_GET['action']=="add" || @$_GET['action']=="edit")?
						' <a href="student.php" class="btn btn-success btn-sm pull-right" style="border-radius:0%">Regresa </a>':'<a href="student.php?action=add" class="btn btn-danger btn-sm pull-right" style="border-radius:0%"><i class="glyphicon glyphicon-plus"></i> Agregar Nuevo Estudiante</a>';
						?>
						</h1>
			...
			<script type="text/javascript" src="js/validation/jquery.validate.min.js"></script>
               ...
               <div class="panel panel-success">
                        <div class="panel-heading">
                           <?php echo ($action=="add")? "Agregar Detalles Estudiante": "Editar Detalles Estudiante"; ?>
                        </div>
						...
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">Cursos* </label>
								<div class="col-sm-10">
									...
									{
									echo '<option value="'.$r['id'].'"  '.(($grade==$r['id'])?'selected="seleccione"':'').'>'.$r['grade'].'</option>';
									}
									?>									
						...
						<div class="form-group">
							...
							<fieldset class="scheduler-border" >
						 <legend  class="scheduler-border">Informacion de Pagos:</legend>
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">Total Pagos* </label>
								<div class="col-sm-10">
						...
						?>
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">Pago por Adelantado* </label>
								<div class="col-sm-10">
						...
						?>
							<div class="form-group">
								<label class="col-sm-2 control-label" for="Password">Observacion Pagos </label>
								<div class="col-sm-10">
						...
						?>
							 ...
							 <fieldset class="scheduler-border" >
						 <legend  class="scheduler-border">Informacion Opcional:</legend>
							<div class="form-group">
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">Direccion de Correo Electronico </label>
								<div class="col-sm-10">
                            ...
                            <div class="table-sorting table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="tSortable22">
									...
									echo '<tr '.(($r['balance']>0)?'class="primary"':'').'>
											...
											<a onclick="return confirm(\'¿Estás seguro de que deseas desactivar este registro?\');" href="student.php?action=delete&id='.$r['id'].'" class="btn btn-danger btn-xs" style="border-radius:60px;"><span class="glyphicon glyphicon-remove"></span></a> </td>
