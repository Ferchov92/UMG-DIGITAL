...
{
$errormsg = "<div class='alert alert-success'> La calificación se ha agregado correctamente.</div>";
}else if(isset($_REQUEST['act']) && @$_REQUEST['act']=="2")
{
$errormsg = "<div class='alert alert-success'> La calificación se ha actualizado correctamente.</div>";
}
else if(isset($_REQUEST['act']) && @$_REQUEST['act']=="3")
{
$errormsg = "<div class='alert alert-success'> La calificación se ha eliminado correctamente.</div>";
}
...
?>
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Carrera 
						<?php
						echo (isset($_GET['action']) && @$_GET['action']=="add" || @$_GET['action']=="edit")?
						' <a href="grade.php" class="btn btn-success btn-sm pull-right" style="border-radius:0%">Regresar </a>':'<a href="grade.php?action=add" class="btn btn-danger btn-sm pull-right" style="border-radius:0%"><i class="glyphicon glyphicon-plus"></i> Agregar Nueva Carrera </a>';
						?>
						</h1>
