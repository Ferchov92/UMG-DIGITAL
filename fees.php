...
{
$errormsg = "<div class='alert alert-success'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a><strong>Exitoso!</strong> Se han presentado los pagos</div>";
}
...
<form class="form-inline" role="form" id="searchform">
  <div class="form-group">
   ...
   <div class="form-group">
    <label for="email"> Fecha de Inscripcion </label>
  ...
  <button type="reset" class="btn btn-danger btn-sm" style="border-radius:0%" id="clear" > Reiniciar </button>
</form>
</fieldset>
...
function mydatatable()
{
              ...
              $("#subjectresult").html('<table class="table table-striped table-bordered table-hover" id="tSortable22"><thead><tr><th>Nombre/Contacto</th><th>Pagos</th><th>Saldo</th><th>Carreras</th><th>Fecha</th><th>Acciones</th></tr></thead><tbody></tbody></table>');
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Cobro de Pagos</h4>
        </div>
