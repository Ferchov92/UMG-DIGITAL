...
echo '  <form class="form-horizontal" id ="signupForm1" action="fees.php" method="post">
  ...
  <div class="form-group">
    <label class="control-label col-sm-2" for="email">Pagado:</label>
    <div class="col-sm-10">
  ...
  <div class="form-group"> 
    <div class="col-sm-offset-2 col-sm-10">
      <button type="submit" class="btn btn-info" style="border-radius:0%" name="save">Guardar</button>
    </div>
  </div>
</form>
